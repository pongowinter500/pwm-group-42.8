...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    HeroAboutPage: Schema.Attribute.Component<
      'about-page-components.hero',
      false
    > &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    mission: Schema.Attribute.Component<'about-page-components.mission', false>;
    offer: Schema.Attribute.Component<'about-page-components.offer', false>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiBusinessPageBusinessPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    feature: Schema.Attribute.Component<
      'business-page-components.features',
      true
    >;
    Hero: Schema.Attribute.Component<'business-page-components.hero', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    catalogueDescription: Schema.Attribute.Text & Schema.Attribute.Required;
    ...
    CourseSubtitle: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    price: Schema.Attribute.Decimal &
      ...
      >;
    publishedAt: Schema.Attribute.DateTime;
    section1Text: Schema.Attribute.Text & Schema.Attribute.Required;
    section1Title: Schema.Attribute.String & Schema.Attribute.Required;
    section2Title: Schema.Attribute.String & Schema.Attribute.Required;
    text: Schema.Attribute.Component<'course-attributes.topic', false> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiInstructorInstructor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ProfessorId: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
